        ...
        if (subCommentContainer.children().length != 1) {
            ...
            e.classList.add("active");
                ...
                $.getJSON("/comment/" + id, function (data) {
                    $.each(data.data.reverse(), function (index, childComment) {
                        ...
                        var mediaBodyElement = $("<div/>", {
                            ...
                            "class": "media-heading",
                            "html": childComment.user.name
                        })).append($("<div/>", {
                            "html": childComment.content
                        })).append($("<div/>", {
                            "class": "menu"
                        }).append($("<span/>", {
                            "class": "pull-right",
                            "html": moment(childComment.gmtCreate).format('YYYY-MM-DD')
                        })));
